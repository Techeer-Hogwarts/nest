module.exports = {
  ...
  rules: {
    ...
    "object-property-newline": ["error", { "allowAllPropertiesOnSameLine": false }], // 객체의 프로퍼티가 여러 줄일 경우, 첫번째 프로퍼티는 첫 줄에, 나머지는 각각 한 줄씩
    "object-curly-newline": ["error", { // {} 안의 줄 바꿈 방식 설정
    ...
    "comma-dangle": ["error", "always"], // 마지막 항목 뒤 콤마 강제, git diff 가독성 향상
